...
### **上下文减少 71.3%，估算节省 18,485 tokens，有损基准样例全部恢复成功。**

12 个内置基准场景合计从 **86,467 B 降至 24,846 B**，其中 **10/10 个有损样例均成功恢复完整原文**。[查看完整实测数据。](#实际能节省多少)
...
- **降低上下文成本**：内置基准样例体积减少 **71.3%**，从 86,467 字节降至 24,846 字节。
...
| CSV 表格 | 7,187 B | 2,258 B | 68.6% | 1,479 | PASS |
| **合计** | **86,467 B** | **24,846 B** | **71.3%** | **18,485** | **10/10 有损样例恢复成功** |
...
| CSV、TSV、Markdown 表格 | 严格解析列结构后复用 SmartCrusher，保留代表记录和异常记录 |
