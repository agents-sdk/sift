...
### **上下文减少 73.2%，估算节省 16,586 tokens，有损基准样例全部恢复成功。**

9 个内置基准场景合计从 **75,546 B 降至 20,257 B**，其中 **7/7 个有损样例均成功恢复完整原文**。[查看完整实测数据。](#实际能节省多少)
...
- **降低上下文成本**：内置基准样例体积减少 **73.2%**，从 75,546 字节降至 20,257 字节。
...
| **合计** | **75,546 B** | **20,257 B** | **73.2%** | **16,586** | **7/7 有损样例恢复成功** |
