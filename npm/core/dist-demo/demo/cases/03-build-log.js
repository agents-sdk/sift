...
lines.push('error[E0308]: mismatched types', '  --> src/main.rs:42:13', '   | let x: String = 42;', 'error: could not compile `demo` due to 1 previous error');
exports.buildLogCase = {
    id: 'build-log',
    title: 'Cargo 构建日志',
