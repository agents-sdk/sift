...
### **コンテキストを 61.8% 削減。推定 13,497 トークンを節約。非可逆ベンチマークはすべて復元成功。**

8 つの内蔵ベンチマーク全体で **72,823 B から 27,833 B** へ削減し、**非可逆 5/5 ケースで原文の復元に成功**しました。[測定結果の詳細を見る。](#どれくらい削減できるか)
...
- **コンテキストコストの削減** — 内蔵ベンチマークでは 72,823 バイトから 27,833 バイトへ、**61.8% 削減**しました。
...
| **合計** | **72,823 B** | **27,833 B** | **61.8%** | **13,497** | **非可逆 5/5 件を復元** |
