...
### **コンテキストを 73.2% 削減。推定 16,586 トークンを節約。非可逆ベンチマークはすべて復元成功。**

9 つの内蔵ベンチマーク全体で **75,546 B から 20,257 B** へ削減し、**非可逆 7/7 ケースで原文の復元に成功**しました。[測定結果の詳細を見る。](#どれくらい削減できるか)
...
- **コンテキストコストの削減** — 内蔵ベンチマークでは 75,546 バイトから 20,257 バイトへ、**73.2% 削減**しました。
...
| **合計** | **75,546 B** | **20,257 B** | **73.2%** | **16,586** | **非可逆 7/7 件を復元** |
